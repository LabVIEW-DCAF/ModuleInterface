...
<Project Type="Project" LVVersion="13008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="runtime" Type="Folder">
			<Item Name="TBM module execution interface.lvclass" Type="LVClass" URL="../runtime/TBM module execution interface.lvclass"/>
		</Item>
		<Item Name="tag bus module sample project" Type="Folder">
			<Item Name="documentation" Type="Folder">
				<Item Name="tag bus module doc.html" Type="Document" URL="../sample project/Source/tag bus module sample project/documentation/tag bus module doc.html"/>
			</Item>
			<Item Name="images" Type="Folder">
				<Item Name="datacomp.png" Type="Document" URL="../sample project/Source/tag bus module sample project/images/datacomp.png"/>
			</Item>
			<Item Name="module" Type="Folder">
				<Item Name="configuration" Type="Folder">
					<Item Name="sample module configuration.lvclass" Type="LVClass" URL="../sample project/Source/tag bus module sample project/module/configuration/sample module configuration.lvclass"/>
				</Item>
				<Item Name="execution" Type="Folder">
					<Item Name="sample module runtime.lvclass" Type="LVClass" URL="../sample project/Source/tag bus module sample project/module/execution/sample module runtime.lvclass"/>
				</Item>
			</Item>
			<Item Name="scripting" Type="Folder">
				<Item Name="DecideModuleFeatures.lvclass" Type="LVClass" URL="../sample project/Source/tag bus module sample project/scripting/DecideModuleFeatures.lvclass"/>
			</Item>
			<Item Name="tests" Type="Folder">
				<Item Name="sample module tests.lvlib" Type="Library" URL="../sample project/Source/tag bus module sample project/tests/sample module tests.lvlib"/>
			</Item>
			<Item Name="Sample Tag Bus Module.lvproj" Type="Document" URL="../sample project/Source/tag bus module sample project/Sample Tag Bus Module.lvproj"/>
		</Item>
		<Item Name="tests" Type="Folder">
			<Item Name="TBM Tests.lvlib" Type="Library" URL="../tests/TBM Tests.lvlib"/>
		</Item>
